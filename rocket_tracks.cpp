...
static track_key ship_updateMatcap_keys[] = {{ 0, 1.000000, KEY_STEP}, { 768, 0.000000, KEY_STEP}, };
const sync_track ship_updateMatcap = { "ship:updateMatcap", ship_updateMatcap_keys,2};
